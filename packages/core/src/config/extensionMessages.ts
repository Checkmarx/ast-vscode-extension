...
export const CHECKMARX_MESSAGES: ExtensionMessages = {
    ...
    assistViewDescription: 'Checkmarx One Assist stops vulnerabilities where your code is written, with fixes you can actually trust.',
...
export const DEVASSIST_MESSAGES: ExtensionMessages = {
    ...
    assistViewDescription: 'Checkmarx Developer Assist stops vulnerabilities where your code is written, with fixes you can actually trust.',
