<img src="https://checkmarx-my.sharepoint.com/:i:/p/anurag_dalke/EZhigsY_rWNOjkucYDgVMnwB_I-Tkse6petddL4CMMTuHg?e=PonFvt">
...
<br />
<p align="center">
  <h3 align="center">CxOne VS Code Extension</h3>
  <p align="center">
...
The CxOne Visual Studio Code extension integrates seamlessly into your IDE, identifying vulnerabilities in your proprietary code, open source dependencies, and IaC files. The extension offers actionable remediation insights in real-time.
...
![Running a Scan from the IDE](https://checkmarx.com/resource/documents/en/image/164fe2f63eb613.gif "Running a Scan from the IDE")


### Key Features
 - **Full one Platform Access**
  - Access the full suite of Checkmarx One tools— SAST, SCA, IaC Security, and Secret Detection— from within    
    your IDE.
  - No need to leave your coding environment.
 - **Pre-Commit and On-Demand Scanning**
   - Run scans before committing code or import existing scan results from your Checkmarx One account to        
     analyze and remediate findings.
 - **Branch Rescanning and Management**
   - Easily rescan your local branch or create a new scan branch in CxOne mapped to your workspace branch.
 - **Actionable Vulnerability Insights**
   - Get actionable security results with remediation advice. 
   - Navigate directly from the result to the vulnerable line of code in the editor.
   - SAST Remediation with Code Samples
     Understand vulnerabilities faster with remediation guidance that includes real-world code examples.
 - **Grouping and Filtering**
   - Easily filter and group scan results by severity, type, or category to prioritize critical issues first.
 - **In-IDE Triage Support**
   - Triage results directly in VS Code: update severity, status, and add comments without switching contexts.
 - **Codebashing Integration**
   - Learn secure coding in context with links to interactive Codebashing lessons for each issue.
 - **Auto Remediation for Open Source**
   - Apply one-click Auto Remediation to update to safe versions of vulnerable open-source packages.
-  **AI Guided Remediation**
   - Get help from **AI** to explain vulnerabilities in plain English and recommend fixes with minimal 
     developer effort.
 - **AI Secure Coding Assistant (ASCA)**
   - A lightweight background scanner that identifies security violations and provides real-time remediation  
     advice as you code.
...
![Automatic Remediation for KICS Vulnerabilities](https://checkmarx.com/resource/documents/en/image/164fe2f6455bbe.gif)
...
![Installing and Setting up the Extension](https://checkmarx.com/resource/documents/en/image/164fe2f63b6314.gif "Installing and Setting up the Extension")
