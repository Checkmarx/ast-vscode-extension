		...
		<div class="card" style="border:none;margin-bottom:1em;background:transparent;">
               <div class="card-body" style="padding:0">
                  ...
                  <div class="row" style="margin-top:0.8em">
                     <div class="col">
						...
						<p>”AI Guided Remediation” harnesses the power of AI to help you to understand the vulnerabilities in your code, and resolve them quickly and easily.</p>
			...
			<div class="row" style="margin-top:1em">
				<div class="col">
					...
					”AI Guided Remediation” will only answer questions that are relevant to this IaC file and its results.The responses are generated by OpenAI's GPT. The content may contain inaccuracies. Use your judgement in determining how to utilize this information.
					</p>
				</div>
			</div>
		</div>
