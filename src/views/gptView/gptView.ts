		...
		<div class="card" style="border:none;margin-bottom:1em;background:transparent;">
			...
			<div class="row" style="margin-top:1em">
				<div class="col">
					...
					This content is AI-generated by GPT, powered by OpenAI Service. Use and rely on its output at your own judgment. The content may contain inaccuracies. ”AI Guided Remediation” will answer only questions that are relevant to this IaC file and its results.
					</p>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid" style="margin-bottom:10px">
			<div class="row" style="bottom: 10px">
					...
					<div class="input-group" style="display:flex" id="askGroup">
						...
						<span style="border:1px solid rgba(55, 148, 255, 0.2);display:flex;justify-content:center;align-items:center;border-radius:0;background:#6769725c;width:10%;border-style:solid solid solid none;border-color:#3794FF" class="input-group-addon btn btn-primary" id="userQuestion">
