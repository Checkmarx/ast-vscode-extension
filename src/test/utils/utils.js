...
exports.delay = exports.validateRootNode = exports.validateNestedGroupBy = exports.getDetailsView = exports.validateSeverities = exports.getResults = exports.getQuickPickSelector = exports.quickPickSelector = exports.createTreeSCA = exports.initializeSCA = exports.initialize = exports.createTree = exports.createView = exports.createControl = void 0;
const vscode_extension_tester_1 = require("vscode-extension-tester");
const constants_1 = require("./constants");
async function createControl() {
    const r = await new vscode_extension_tester_1.ActivityBar().getViewControl('Checkmarx');
    return r;
}
...
async function createTree(view) {
    return await (view === null || view === void 0 ? void 0 : view.getContent().getSection("Checkmarx One Results"));
}
...
async function validateRootNode(scan) {
    ...
    const engines = await (scan === null || scan === void 0 ? void 0 : scan.getChildren());
    await (0, exports.delay)(constants_1.THREE_SECONDS);
