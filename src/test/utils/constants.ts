...
export const CX_NAME: string = "Checkmarx One";
...
export const CX_SCA_SCAN: string = "ast-results: createSCAScan";
...
export const STEP_1: string = "Checkmarx One Scan selection (1/3)";
export const STEP_2: string = "Checkmarx One Scan selection (2/3)";
export const STEP_3: string = "Checkmarx One Scan selection (3/3)";
