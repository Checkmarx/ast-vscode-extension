    ...
    this.detailsPanel.webview.onDidReceiveMessage(async (data) => {
      switch (data.command) {
        ...
        case "scaFix":
          ...
          break;
        case "gpt":
          this.logs.info("Opening AI Security Champion");
          ...
          break;
        case "explainFile":
          this.logs.info("AI Security Champion : Can you explain this IaC file?");
          ...
          break;
        case "explainResults":
          this.logs.info("AI Security Champion : Can you explain these results?");
        ...
        case "explainRemediations":
          this.logs.info("AI Security Champion : Can you offer a remediation suggestion?");
          ...
          break;
        case "userQuestion":
          this.logs.info("AI Security Champion : " + data.question);
          ...
          break;
        case "startSastChat":
          this.logs.info("AI Security Champion : Start Chat");
