...
export class WorkspaceListener {
    ...
    constructor() {
        this._createScanButton = new ContextKey(`${EXTENSION_NAME}.createScanButton`);
        this._cancelScanButton = new ContextKey(`${EXTENSION_NAME}.cancelScanButton`);
    }

    listener(context: vscode.ExtensionContext, astResultsProvider: AstResultsProvider) {
        this.isScanButtonEnabled(context, astResultsProvider);
    }

    isScanButtonEnabled(context: vscode.ExtensionContext, astResultsProvider: AstResultsProvider) {
        ...
        if (this._createScanButton.set(project?.id && branch?.id && (!runningScan?.id && !preparingScan?.id))
