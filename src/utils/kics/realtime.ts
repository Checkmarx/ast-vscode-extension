...
export function applyKicsDiagnostic(
...
// Register codeLens
export function applyKicsCodeLensProvider(
...
export function getKicsCodeLensProvider(
  kicsResults: CxKicsRealTime
...
export function generateCodeLens(
  resultsmap: Map<number, KicsSummary>
): vscode.CodeLens[] {
