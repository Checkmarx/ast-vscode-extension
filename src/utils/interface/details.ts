			...
			<div class="card-body" style="padding:0">
				...
				<div class="row" style="margin-top:0.8em">
					<div class="col">
						...
						<p>”AI Security Champion” harnesses the power of AI to help you to understand the
		...
		<div class="row" style="margin-top:1em">
			<div class="col">
				<p style="color:#676972;font-size:12px">
					”AI Security Champion” will only answer questions that are relevant to this IaC file and its
