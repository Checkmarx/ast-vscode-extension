/**
 * Update dev version for Project Ignite extension in monorepo structure
 * 
 ...
 * we have.
 * 
 * This script updates the version in packages/project-ignite/package.json
 */
const fs = require('fs');
const path = require('path');

const pkgPath = path.join(__dirname, '..', '..', 'packages', 'project-ignite', 'package.json');
...
console.log(`Update Project Ignite package.json with dev version:\n\n${JSON.stringify(pkg, null, 2)}`);
